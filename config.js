...
module.exports = {
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '6281395861695@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ YᴀNZsᴇʀ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'YANZSER' : process.env.BOT_NAME,
